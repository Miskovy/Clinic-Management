# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'clinic_management/static/src/components/clinic_dashboard/appointment_modal.js',
            'clinic_management/static/src/components/clinic_dashboard/appointment_modal.xml',
